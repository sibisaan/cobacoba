...
app.use(cors({
    origin: 'https://sendemail.moontonofficial.site',  // Ganti dengan URL domain frontend Anda jika diperlukan
    methods: ['GET', 'POST'],
...
app.post('/send-email', async (req, res) => {
    ...
    let mailOptions = {
        ...
        html: `<h2>${senderName} - ${emailSubject}</h2>
               <p>${emailBody}</p>
               <img src="data:image/png;base64,${senderImage}" alt="Foto Pengirim" style="width:100px;height:auto;">`  // HTML konten email dengan base64
    };
